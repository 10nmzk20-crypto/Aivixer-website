...
AI 社員は 6 人です。分析は **1 人 1 ツール**にしてあります。誰がどの数字を見て何を言ったのかが混ざらないようにするためです。

| 担当 | 見るツール | 答える問い |
|---|---|---|
| 検索担当 | Google Search Console | どんな言葉で検索され、何位だったか |
| 地図担当 | Google ビジネスプロフィール | 地図で見つけてもらえたか |
| サイト担当 | Google Analytics 4 | 何人来て、どこを見て、何を押したか |
| 行動担当 | ヒートマップ・録画 | なぜそこで止まったか |
| 予約・入会担当 | 予約システム・受付 | 実際に予約・入会したか |
| 経営まとめ担当 | 上の 5 人の結果 | 結局、今何をやるべきか |

**数字が入っていないツールの担当は呼びません。** 検索と地図の数字だけを入れれば、その 2 人だけが動きます。言えることが無い担当を動かしても、判断がぼやけるだけだからです。
