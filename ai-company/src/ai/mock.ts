  ...
  tasks: [
    {
      ...
      manual_reason: null,
      head_on_competition: 1,
      uses_strength: 5,
      winnable_segment: 5,
      price_competition: false,
      sunzi_note: "大手が案内に人を割いているところを、先に文章で解消する。設備数でも価格でも戦わない。",
      customer_trust: 5,
      staff_burden: 1,
      brand_long_term: 4,
      short_term_bias: false,
      confucius_note: "料金と辞め方を先に開示するため、契約の分かりにくさが減り、見学者の不安も下がる。",
      difficulty: 2,
    ...
    },
    {
      ...
      winnable_segment: 4,
      price_competition: false,
      sunzi_note: "人力営業に頼らず、検索した時点で ViXer の強みが伝わる。大手と同じ土俵では戦わない。",
      customer_trust: 3,
      staff_burden: 2,
      brand_long_term: 5,
      short_term_bias: false,
      confucius_note: "不安の解消には効くが、顧客と直接やり取りする場面ではないため、信頼への効き方は間接的。",
      difficulty: 2,
      cost_estimate: "0 円",
    ...
    },
    {
      ...
      winnable_segment: 5,
      price_competition: false,
      sunzi_note: "「初心者で何をすればよいか分からない」「静かに自分のペースで使いたい」層に、大型ジムが用意していない答えを出す。",
      customer_trust: 5,
      staff_burden: 1,
      brand_long_term: 5,
      short_term_bias: false,
      confucius_note: "会員が自分で始められるようになり、不安が減る。スタッフの負担も増えない。",
      difficulty: 3,
